...
<head>
  ...
  <style>
    .blackjack-table {
      background-image: url('IMG/mesa_blackjack.webp');
            ...
            <div id="gameControls" class="card-footer" style="display: none;">
              ...
              <div class="d-grid gap-2 d-md-flex justify-content-center">
                <button id="hitBtn" class="btn btn-warning btn-lg">
                  <i class="fas fa-plus-circle me-2"></i>Pedir 
                </button>
                <button id="standBtn" class="btn btn-primary btn-lg" style="--bs-btn-bg-image: none;">
                  <i class="fas fa-hand-paper me-2"></i>Plantarse 
                </button>
